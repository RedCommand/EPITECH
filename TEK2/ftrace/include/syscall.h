...
#include "types.h"
    ...
    static const syscall_t table[330] = {
        ...
        {35, "nanosleep", 2, NUM, CONST_STRUCT_TIMESPEC_P, STRUCT_TIMESPEC_P,
            0, 0, 0, 0},
        ...
        {42, "connect", 3, NUM, NUM, CONST_STRUCT_SOCKADDR_P, SOCKLEN_T, 0, 0,
            0},
        ...
        {51, "getsockname", 3, NUM, NUM, STRUCT_SOCKADDR_P, SOCKLEN_T_P, 0, 0,
            0},
        {52, "getpeername", 3, NUM, NUM, STRUCT_SOCKADDR_P, SOCKLEN_T_P, 0, 0,
            0},
        ...
        {78, "getdents", 3, NUM, UNSIGNED, STRUCT_LINUX_DIRENT_P, UNSIGNED, 0,
            0, 0},
        ...
        {96, "gettimeofday", 2, NUM, STRUCT_TIMEVAL_P, STRUCT_TIMEZONE_P, 0, 0,
            0, 0},
        ...
        {125, "capget", 2, NUM, CAP_USER_HEADER_T, CAP_USER_DATA_T, 0, 0, 0,
            0},
        {126, "capset", 2, NUM, CAP_USER_HEADER_T, CONST_CAP_USER_DATA_T, 0, 0,
            0, 0},
        ...
        {142, "sched_setparam", 2, NUM, NUM, CONST_STRUCT_SCHED_PARAM_P, 0, 0,
            0, 0},
        {143, "sched_getparam", 2, NUM, NUM, STRUCT_SCHED_PARAM_P, 0, 0, 0, 0},
        {144, "sched_setscheduler", 3, NUM, NUM, NUM,
        ...
        {165, "mount", 5, NUM, STRING, STRING, STRING, UNSIGNED, CONST_VOID_P,
            0},
        ...
        {180, "nfsservctl", 3, NUM, NUM, STRUCT_NFSCTL_ARG_P,
        ...
        {203, "sched_setaffinity", 3, NUM, NUM, NUM, CONST_CPU_SET_T_P, 0, 0,
            0},
        ...
        {208, "io_getevents", 5, NUM, AIO_CONTEXT_T, NUM, NUM,
        ...
        {217, "getdents64", 3, NUM, UNSIGNED, STRUCT_LINUX_DIRENT64_P,
            UNSIGNED, 0, 0, 0},
        ...
        {224, "timer_gettime", 2, NUM, TIMER_T, STRUCT_ITIMERSPEC_P, 0, 0, 0,
            0},
        {225, "timer_getoverrun", 1, NUM, TIMER_T, 0, 0, 0, 0, 0},
        {226, "timer_delete", 1, NUM, TIMER_T, 0, 0, 0, 0, 0},
        {227, "clock_settime", 2, NUM, CLOCKID_T, CONST_STRUCT_TIMESPEC_P, 0,
            0, 0, 0},
        {228, "clock_gettime", 2, NUM, CLOCKID_T, STRUCT_TIMESPEC_P, 0, 0, 0,
            0},
        {229, "clock_getres", 2, NUM, CLOCKID_T, STRUCT_TIMESPEC_P, 0, 0, 0,
            0},
        {230, "clock_nanosleep", 4, NUM, CLOCKID_T, NUM,
        ...
        {237, "mbind", 6, NUM, VOID_P, UNSIGNED, NUM, CONST_UNSIGNED_P,
            UNSIGNED, UNSIGNED},
        {238, "set_mempolicy", 3, NUM, NUM, CONST_UNSIGNED_P, UNSIGNED, 0, 0,
            0},
        ...
        {245, "mq_getsetattr", 3, NUM, MQD_T, STRUCT_MQ_ATTR_P,
        ...
        {271, "ppoll", 4, NUM, STRUCT_POLLFD_P, UNSIGNED,
            CONST_STRUCT_TIMESPEC_P, CONST_SIGSET_T_P, 0, 0},
        {272, "unshare", 1, NUM, NUM, 0, 0, 0, 0, 0},
        {273, "set_robust_list", 2, NUM, STRUCT_ROBUST_LIST_HEAD_P, NUM, 0, 0,
            0, 0},
        {274, "get_robust_list", 3, NUM, NUM, STRUCT_ROBUST_LIST_HEAD_P, NUM_P,
            0, 0, 0},
        {275, "splice", 6, NUM, NUM, LNUM_P, NUM, LNUM_P, NUM, UNSIGNED},
        {276, "tee", 4, NUM, NUM, NUM, NUM, UNSIGNED, 0, 0},
        {277, "sync_file_range", 4, NUM, NUM, OFF64_T, OFF64_T, UNSIGNED, 0,
            0},
        {278, "vmsplice", 4, NUM, NUM, CONST_STRUCT_IOVEC_P, UNSIGNED,
            UNSIGNED, 0, 0},
        {279, "move_pages", 6, NUM, NUM, UNSIGNED, VOID_P, CONST_NUM_P, NUM_P,
            NUM},
        {280, "utimensat", 4, NUM, NUM, STRING, CONST_STRUCT_TIMESPEC, NUM, 0,
            0},
        ...
        {288, "accept4", 4, NUM, NUM, STRUCT_SOCKADDR_P, SOCKLEN_T_P, NUM, 0,
            0},
        ...
        {298, "perf_event_open", 5, NUM, STRUCT_PERF_EVENT_ATTR_P, NUM, NUM,
            NUM, UNSIGNED, 0},
        {299, "recvmmsg", 5, NUM, NUM, STRUCT_MMSGHDR_P, UNSIGNED, UNSIGNED,
            STRUCT_TIMESPEC_P, 0},
        {300, "fanotify_init", 2, NUM, UNSIGNED, UNSIGNED, 0, 0, 0, 0},
        {301, "fanotify_mark", 5, NUM, NUM, UNSIGNED, UNUM64_T, NUM, STRING,
            0},
        {302, "prlimit64", 6, 0, 0, 0, 0, 0, 0, 0},
        {303, "name_to_handle_at", 5, NUM, NUM, STRING, STRUCT_FILE_HANDLE_P,
            NUM_P, NUM, 0},
        {304, "open_by_handle_at", 3, NUM, NUM, STRUCT_FILE_HANDLE_P, NUM, 0,
            0, 0},
        {305, "clock_adjtime", 6, 0, 0, 0, 0, 0, 0, 0},
        {306, "syncfs", 1, NUM, NUM, 0, 0, 0, 0, 0},
        {307, "sendmmsg", 4, NUM, NUM, STRUCT_MMSGHDR_P, UNSIGNED, UNSIGNED, 0,
            0},
        {308, "setns", 2, NUM, NUM, NUM, 0, 0, 0, 0},
        {309, "getcpu", 3, NUM, UNSIGNED_P, UNSIGNED_P, STRUCT__CACHE_P, 0, 0,
            0},
        ...
        {314, "sched_setattr", 3, NUM, NUM, STRUCT_SCHED_ATTR_P, UNSIGNED, 0,
            0, 0},
        ...
        {320, "kexec_file_load", 5, NUM, NUM, NUM, UNSIGNED, STRING, UNSIGNED,
            0},
